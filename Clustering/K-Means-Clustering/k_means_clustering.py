...
# X = dataset.iloc[:, 1:].values ## creating matrix of all feature
Y = dataset.iloc[:, [3, 4]].values ## creating matrix of only two features
...
plt.scatter(kmeans.cluster_centers_[:, 0], kmeans.cluster_centers_[:, 1], s=300, color='yellow', label='Centroide')
